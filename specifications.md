...
Money that has not arrived is asked about again every week, because the answer can change between two Mondays — and the asking stops once the renters have arrived. Everything else is said once: an inventory nobody recorded will still be true next week, and repeating it teaches a unit to ignore the whole channel.
