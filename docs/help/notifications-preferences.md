...
Cette page décide, type par type, comment chaque notification vous
atteint. Tout s'enregistre dès que vous touchez un interrupteur — il
n'y a pas de bouton « Enregistrer ».

## Les trois canaux

Chaque ligne du tableau propose trois interrupteurs :
...
sur le site — vous devez toujours en être averti.
