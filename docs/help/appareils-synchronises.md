...
question: Que se passe-t-il si je révoque un accès ?
question: Où retrouver l'adresse du serveur et le mot de passe ?
paths: /account/devices
related: mon-compte, synchronisation-contacts, carnet-adresses-synchronise
---

Depuis Mon compte, « Synchroniser mes contacts » ouvre la liste des accès
...
Donnez-lui un nom, puis « Créer un accès ». Le site affiche
...
Un accès créé et jamais utilisé reste un identifiant valide. Le
