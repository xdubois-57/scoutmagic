...
/**
 * Implements the core FunctionFlagsProvider hook so the Correspondances
 * Desk configuration page can let admins mark, per function, whether it's
 * a section's "responsable" — without the core page hardcoding any
 * function name. Every active chief/chief-d'unité member is shown on the
