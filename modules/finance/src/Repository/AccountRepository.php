...
class AccountRepository
{
    ...
    public function create(
        ...
        $stmt->execute([
            ...
            $accountType,
            $sectionId,
            $iban !== null ? $this->encryption->encrypt($iban, 'finance_accounts.iban') : null,
            $iban !== null ? $this->encryption->blindIndex($iban, 'finance_iban') : null,
            $holderName !== null ? $this->encryption->encrypt($holderName, 'finance_accounts.holder_name') : null,
            $roleMinView,
            $isDefault ? 1 : 0,
        ]);
