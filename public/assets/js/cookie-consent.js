...
(function () {
    ...
    // Outside the listener, and the file inside an IIFE so that hoisting it
    // out of the callback does not make it a global: it borrows nothing
    // from the page and is the same function on every failed POST.
    /**
