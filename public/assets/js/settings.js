...
(function () {
    ...
    // A pure string builder — it reads nothing from the page, so it lives
    // beside the listener rather than inside it. The IIFE is what keeps
    // that from meaning "global".
    /**
     * @param {string} type
     * @param {string} value
     * @param {string} regex
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('settingEditSave').addEventListener('click', async function() {
            ...
            var value = input.type === 'checkbox' ? checked : input.value;
