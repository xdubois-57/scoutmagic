...
class SqlParserTest extends TestCase
{
    ...
    public function testParsingActualCoreSqlFileSucceeds(): void
    {
        ...
        $this->assertContains('help_topics_seen', $tableNames);
        ...
        $this->assertContains('member_desk_id_aliases', $tableNames);
        $this->assertContains('member_duplicate_candidates', $tableNames);
        ...
        $this->assertContains('section_staff_photos', $tableNames);
        $this->assertContains('member_emails', $tableNames);
        $this->assertContains('member_section_periods', $tableNames);
        $this->assertContains('section_documents', $tableNames);
        $this->assertContains('badges', $tableNames);
        $this->assertContains('member_badges', $tableNames);
        $this->assertContains('push_subscriptions', $tableNames);
        $this->assertContains('notifications', $tableNames);
        $this->assertContains('backups', $tableNames);
        $this->assertContains('update_history', $tableNames);
        $this->assertContains('scout_year_transition_steps', $tableNames);
