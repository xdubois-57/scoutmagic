...
final class UserFacingExceptionInventoryTest extends TestCase
{
    ...
    private const USER_FACING = [
        ...
        \Core\Page\TextPageException::class,
        \Core\Security\SsrfValidationException::class,
        \Core\Geo\GeoPointException::class,
        ...
        \Modules\Finance\Api\FinanceException::class,
        ...
        \Modules\Groups\Api\GroupPublishException::class,
