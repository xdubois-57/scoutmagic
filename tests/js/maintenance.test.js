...
/*
 * The off-site destination's « Tester » button used to live here.
 *
 * It moved to the storage page in IT-05, with everything else about the
 * destination: a Drive folder is a storage location now, and a location
 * already has a « Tester » button of its own
 * (`storage-locations.js`, `tests/js/storage-locations.test.js`). Two
 * buttons testing the same thing, on two pages, is two behaviours to keep
 * in agreement — and exactly the kind of thing that drifts.
 */
