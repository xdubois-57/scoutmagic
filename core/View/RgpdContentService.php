...
22bis. **Carte et géocodage (module camps)** : Le contenu de référence décrit en section 4.2 le paragraphe "Fond de carte et géocodage" (OpenStreetMap Foundation) et introduit une catégorie de personnes concernées que ce site n'a nulle part ailleurs : des **tiers extérieurs à l'unité** (propriétaires et gestionnaires de terrains de camp), qui n'ont aucun lien avec l'unité et aucun compte sur le site.
    ...
    - Si le module camps ET le module inbound_mail sont tous deux actifs : conserve le paragraphe "Rattachement à un séjour déjà connu" de la sous-section "Module Courrier entrant". Il décrit un traitement DISTINCT de la création automatique décrite juste après, et il faut le dire ainsi : un message annonçant une période — « du 18 au 20 septembre 2026 », ou les lignes « Arrivée » et « Départ » d'un contrat — est rattaché au séjour déjà encodé qui couvre exactement ces jours-là. Ce rattachement n'écrit AUCUNE donnée nouvelle, n'appelle AUCUN modèle d'intelligence artificielle, et ne dépend PAS du réglage de création automatique : conserve-le même si ce réglage est désactivé et même en l'absence de connecteur IA. Dis aussi que plusieurs séjours couvrant la même période ne produisent aucun rattachement mais des propositions au chef d'unité, que l'objet et le corps sont lus d'abord et le texte des pièces jointes seulement s'ils n'ont rien donné, et que le rattachement est affiché explicitement comme « Période annoncée dans le message », donc comme un rapprochement et non comme une certitude.
...
34. **Fréquentation du site (module usage_stats)** : s'il ne figure PAS dans la liste des modules actifs ({$modulesText}), retire le paragraphe correspondant de la section 4.1 : rien n'est compté. S'il est actif, conserve-le et n'édulcore rien. Conserve en particulier : (a) que le site compte les **pages ouvertes**, par mois et par grande catégorie de public (visiteur anonyme, membre identifié, staff) ; (b) que le comptage porte sur le **motif** de la page (« la page d'un membre ») et jamais sur l'adresse consultée, de sorte qu'**aucun identifiant de membre n'est enregistré** — ne décris jamais ce traitement comme un suivi de navigation, un profilage ou une mesure d'audience nominative, il n'en est pas un ; (c) qu'**aucun cookie n'est déposé** pour cette mesure et que c'est la raison pour laquelle elle n'apparaît dans aucune catégorie des préférences de cookies — un lecteur qui ne l'y trouve pas doit lire ici pourquoi ; (d) qu'aucune adresse IP, aucun navigateur et aucun parcours individuel ne sont conservés ; (e) que ces compteurs restent sur le serveur, à l'exception du total par module lorsque l'envoi quotidien de statistiques est activé (règle 28) ; (f) qu'ils sont supprimés après trois années scoutes. N'invente aucun sous-traitant pour ce traitement : il n'en engage aucun.
