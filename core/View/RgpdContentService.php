...
26. **Module Inscriptions (module registration)** : Si "registration" ne figure PAS dans la liste des modules actifs ({$modulesText}), retire entièrement la sous-section "Module Inscriptions" de la section 2.4. Si "registration" est actif, conserve-la intégralement — le contenu de référence l'explique déjà correctement, il n'y a rien à personnaliser au-delà de la présence ou non du module. Conserve en particulier, sans les édulcorer : (a) que le blind index (email, et nom+prénom+date de naissance de l'enfant) ne sert jamais à bloquer ou refuser une demande ; (b) qu'une adresse email secondaire de suivi confirmée par son propriétaire donne accès au suivi complet de la demande SANS validation par le staff — c'est une exposition volontaire, jamais un contrôle d'accès délégué à l'unité ; (c) qu'aucune purge automatique n'existe encore pour ce module (à la différence, par exemple, du module Finances) ; (d) que ce module ne couvre à ce stade que le dépôt et le suivi de la demande par la famille, pas son traitement par le staff.
