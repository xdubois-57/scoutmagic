...
22bis. **Carte et géocodage (module camps)** : Le contenu de référence décrit en section 4.2 le paragraphe "Fond de carte et géocodage" (OpenStreetMap Foundation) et introduit une catégorie de personnes concernées que ce site n'a nulle part ailleurs : des **tiers extérieurs à l'unité** (propriétaires et gestionnaires de terrains de camp), qui n'ont aucun lien avec l'unité et aucun compte sur le site.
    ...
    - Si le module camps est actif mais qu'aucun connecteur IA ne l'est ({$providerInfo} n'indique aucun fournisseur actif) : retire le paragraphe "Résumé automatique des lieux de camp" — sans connecteur, cette fonctionnalité ne peut rien envoyer nulle part.
    - Si le module camps ET le module inbound_mail sont tous deux actifs : conserve le paragraphe "Création automatique d'un séjour" de la sous-section "Module Courrier entrant", qui dit qu'un terrain créé automatiquement depuis une boîte dédiée aux camps porte le NOM D'EXPÉDITEUR du message — donc éventuellement le nom d'une personne physique, stocké en clair comme toute donnée d'un lieu — et qu'un chef d'unité peut le corriger, le fusionner ou l'archiver, la création automatique étant par ailleurs désactivable. Si l'un des deux modules est absent, retire ce paragraphe : sans boîte dédiée, rien n'est jamais créé de cette façon.
